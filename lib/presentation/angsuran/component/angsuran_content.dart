...
class AngsuranContent extends StatefulWidget {
  ...
  const AngsuranContent(
      {super.key,
      required this.controller,
      required this.responseTagihanAngsuran});

  @override
  State<AngsuranContent> createState() => _AngsuranContentState();
}

class _AngsuranContentState extends State<AngsuranContent> {
  @override
                                        ...
                                        child: IconButton(
                                          onPressed: () {
                                            Clipboard.setData(
                                              ...
                                              setState(() {
                                                // copiedText = widget.controller.chosedBank.value!.nomorRekening.toString();
                                              });
                                            });
                                          },
