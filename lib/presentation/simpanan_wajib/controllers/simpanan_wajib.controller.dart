...
class SimpananWajibController extends GetxController {
  ...
  SimpananWajibController(this.bankDataUseCase);
  @override
  void onInit() {
    super.onInit();
    getBankData();
  ...
  void sendSimpananDetail(ResponseTagihanSimpanan responseTagihanSimpanan) {
    ...
    if (jumlahPembayaranDetail != null &&
        isBankHasSelected.value &&
        hasSelectedImage.value) {
      if (jumlahPembayaranDetail != responseTagihanSimpanan.totalTagihan) {
        Get.snackbar("Error",
            'Jumlah pembayaran simpanan wajib harus sama dengan tagihan');
      } else {
        Get.toNamed('/detail-simpanan-wajib', arguments: [
          responseTagihanSimpanan,
