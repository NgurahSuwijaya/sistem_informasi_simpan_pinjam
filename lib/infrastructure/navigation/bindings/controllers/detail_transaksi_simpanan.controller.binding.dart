...
import '../../../../presentation/detail_transaksi_simpanan/controllers/detail_transaksi_simpanan.controller.dart';

class DetailTransaksiSimpananControllerBinding extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut(() => Client());
    ...
    Get.lazyPut<DetailTransaksiSimpananController>(
      () => DetailTransaksiSimpananController(Get.find()),
    );
  }
}
